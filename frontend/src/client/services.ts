...
import type { Body_login_login_access_token,Message,NewPassword,Token,UserPublic,UpdatePassword,UserCreate,UserRegister,UsersPublic,UserUpdate,AppointmentCreate,AppointmentPublic,AppointmentsPublic,AppointmentUpdate,ClientAppointmentRequest,ServiceCreate,ServicePublic,ServicesPublic,ServiceUpdate,ClientCreate,ClientPublic,ClientsPublic,ClientUpdate } from './models';
...
export class AppointmentsService {
	 ...
	 * @throws ApiError
	 */
	public static listAppointments(data: TDataListAppointments = {}): CancelablePromise<AppointmentsPublic> {
		const {
limit = 100,
skip = 0,
} = data;
