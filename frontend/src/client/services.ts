...
export class AppointmentsService {
  ...
  public static updateAppointment(
    data: TDataUpdateAppointment,
  ): CancelablePromise<AppointmentPublic> {
    const { apptId, requestBody } = data;
    return __request(OpenAPI, {
      method: "PATCH",
      url: "/api/v1/appointments/{appt_id}",
      path: {
   ...
   * @throws ApiError
   */
  public static listAppointmentsBetween(
    data: TDataListAppointmentsBetween,
  ): CancelablePromise<AppointmentsPublic> {
   ...
   * @throws ApiError
   */
  public static requestAppointment(
    data: TDataRequestAppointment,
  ): CancelablePromise<ClientAppointmentRequest> {
    const { requestBody } = data;
    return __request(OpenAPI, {
      method: "POST",
...
export class ServicesService {
  ...
  public static updateService(
    data: TDataUpdateService,
  ): CancelablePromise<ServicePublic> {
    const { requestBody, svcId } = data;
    return __request(OpenAPI, {
      method: "PATCH",
      url: "/api/v1/services/{svc_id}",
      path: {
   ...
   * @throws ApiError
   */
  public static getServiceAvailability(
    data: TDataGetServiceAvailability,
  ): CancelablePromise<unknown> {
    const { month, svcId, year } = data;
    return __request(OpenAPI, {
      method: "GET",
...
export class ClientsService {
  ...
  public static listClients(
    data: TDataListClients = {},
  ): CancelablePromise<ClientsPublic> {
    const { limit = 100, skip = 0 } = data;
    return __request(OpenAPI, {
      method: "GET",
      url: "/api/v1/clients/",
