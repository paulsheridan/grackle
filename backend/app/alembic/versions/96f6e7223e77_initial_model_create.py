"""Initial model create.

Revision ID: 96f6e7223e77
Revises: 
Create Date: 2024-04-15 22:29:25.391589
...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_appointment_end'), 'appointment', ['end'], unique=False)
    op.create_index(op.f('ix_appointment_start'), 'appointment', ['start'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_appointment_start'), table_name='appointment')
    op.drop_index(op.f('ix_appointment_end'), table_name='appointment')
